...
* **Breadth-First Search** - is the opposite of Depth-First. The search starts at the root and then visit all the children of that root first. Next, the search then visits all of the grandchildren, and so forth.  

...
Wave-Front Planner is a typical example of Breadth-First Search. It is the simplest solution to local minima problem we encountered in potential functions.  
___
Steps:  
* Firstly, the goal pixel is labeled with 2.

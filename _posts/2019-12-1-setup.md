...
Here, the reference point taken while constructing the C-space obstacle $QO_{i}$ is the center of the circle. It is very intutive that for all values of $\theta$ the shape of C-space obstacle $QO_{i}$ will not change.

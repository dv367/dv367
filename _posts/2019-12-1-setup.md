...
## 1.4 ROS Topics:  
```
1. /scan - laser data of an array of size 360, each index corresponds to each angle 
2. /odom - (x,y) coordinates of the robot 
3. /imu  - orientation of the robot
4. /cmd_vel - linear and angular velocity of the robot
```

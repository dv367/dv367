...
It is similar to conventional A\* algorithm, but the difference is that one starts to search from goal to the start. Accordingly, the algorithm will change to

...
For $\epsilon \geq 1$, there is a bias towards nodes that are closer to goal. We may regard weighted A\* as greedy for a very high value of $\epsilon$. The parameter $\epsilon$ determines how "good enough" the solution is.
...
### 7.5 Conclusion
The major difference between A\* and weighted A\* is the tradeoff between optimal solution and computation time.  

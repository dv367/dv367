...
### 10.4 Teleportation
<p align="justify">
Using the above method, the robot may sometimes find itself completely surrounded by obstacles (artificial and the original one's). In this case, the robot should ignore the target for a while and find the nearest free cell; further, it should run A* search to that free cell. During this A* search, the artificial obstacles are removed and placed back again as the search completes. Figure 10.5 clearly demonstrates this behaviour. Whenever this scenarios is encountered by the robot; it implies that the robot has completely explored that area and needs to move out. 
</p>
<p align="center">

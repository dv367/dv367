...
<ol>
  ...
  Developed a multi-robot navigation system by bringing diverse concepts and algorithms such as distributed model predictive control, A\* search algorithm, On-demand Collision Avoidane, and Leader-Follower formation scheme. Validated and test our system in Gazebo environment.<br>
  <img src="{{ site.url }}/assets/gifs/fyp_1.gif" alt="fyp1" style="width:50%;height:45%;"> &nbsp <img src="{{ site.url }}/assets/gifs/fyp_2.gif" alt="fyp2" style="width:50%;height:45%;">
